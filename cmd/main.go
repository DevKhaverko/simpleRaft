...
/*
Для кодирования команды следующий формат:
...
/*
Для декодирования команды:
- получаем тип команды(всегда 1 байт)
- получаем длину ключа(8 байт)
- получаем ключ(начиная с 9 байта и до 9 + длина ключа)
- если это set, то достаем длину значения и само значение
*/
